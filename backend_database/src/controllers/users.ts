...
export const userController ={
    ...
    async getUserById(request: FastifyRequest , reply: FastifyReply): Promise<GetUserResponse | UserErrorResponse> {
    ...
    async getUsers(request: FastifyRequest , reply: FastifyReply): Promise<GetUsersResponse | UserErrorResponse> {
        const { db } = request.server;
    ...
    async createUser(request: FastifyRequest , reply: FastifyReply): Promise<CreateUserResponse | UserErrorResponse> {
